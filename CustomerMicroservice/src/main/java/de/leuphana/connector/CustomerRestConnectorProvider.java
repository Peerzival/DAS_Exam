...
public class CustomerRestConnectorProvider {
	...
	// http://localhost:8281/customer/addcartitemtocart
	...
	// curl -X POST -d "customerId=value&orderId=value"
	// http://localhost:8281/customer/addordertocustomer
	...
	public String dummys() {
		customerRepository.save(new Customer(
				...
				"Am Altenbruecker Ziegelhof 11", new Cart()));
		customerRepository.save(new Customer("Max Gnewuch",
				"Feldstrasse 53", new Cart()));
		Customer customer = customerRepository.save(new Customer(
				"Levin Schnabel", "Am Sande", new Cart()));
